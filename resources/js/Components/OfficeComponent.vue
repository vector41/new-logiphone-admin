...
const branch_types = ref([
    { name: '本社', status: false, key: 'A' },
    { name: '支店', status: true, key: 'B' }
]);
...
const pref = ref(props.branch_obj.pref)
const all_cities = ref([])
const cities = ref([])
const city = ref(props.branch_obj.city)
...
watch([branch_name,keyword,branch_type,phone_1,phone_2,phone_3,fax_1,fax_2,fax_3,
        zip_1,zip_2,pref,city,town, building,memo,infos,imageObjs],(newValue, oldValue) => {
                    ...
                    <td >
                        <div class="flex flex-col gap-2" >
                            <div class="flex flex-row items-center gap-2">
                                ...
                                <Button class="w-20 h-[34px] flex items-center justify-center" @click="searchAddress">〒検索</Button>
                            </div>
                            <div class="flex flex-row items-center gap-2">
