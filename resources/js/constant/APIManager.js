...
const getPhoneBookList = async (
    ...
    let res = await axios.get("/suppliers/employees/getPhoneBookContent", {
        params: {
            page: _page,
            store_pos: _store_pos,
            type_cates: _type_cates,
...
// const getOldCompanyEmployeeData = async (
//     _page,
//     _store_pos,
//     _type_cates,
//     _keyword,
...
//     _address
// ) => {
//     let res = await axios.get("/suppliers/employees/oldAll", {
//         params: {
//             page: _page,
//             store_pos: _store_pos,
//             type_cates: _type_cates,
...
const saveCompanyLPData = async (_company) => {
    let res = await axios.post("/suppliers/company/savelp", {
        company: _company,
    });
...
const saveEmployeeLPData = async (_employee) => {
    let res = await axios.post("/suppliers/employees/save_lp", {
        employee: _employee,
    });
...
const updateEmployeerData = async (_employeer) => {
    let res = await axios.post("/suppliers/employees/update", {
        employeer: _employeer,
    });
...
const getCallHistoriesOfPeriod = async (role, page, startDate, endDate) => {
    ...
    if (res.result == 200) return res.data;
};
