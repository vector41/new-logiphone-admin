                ...
                <div class="w-fill px-10 min-h-[500px]">
                    <div class="w-full h-full flex flex-col m-2 py-4 mx-auto">
                        ...
                        <div class="flex justify-center mt-5 gap-4">
                            <Button type="button" label="クリア" class="border w-32" severity="secondary" outlined
                                @click="clearData" />
                            <Button type="button" label="確 認" class="text-white w-32"
                                @click="confirm_dialog_visible = true" />
                        </div>
                        <Dialog v-model:visible="confirm_dialog_visible" modal header="担当者登録"
                            :style="{ width: '25rem' }">
                            ...
                            <div class="flex justify-end gap-2">
                                <Button type="button" label="キャンセル" severity="secondary" outlined
                                    @click="confirm_dialog_visible = false" />
